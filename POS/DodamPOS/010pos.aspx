...
<asp:Button ID="CatCloth" runat="server" ClientIDMode="Static" Text="Cloth" CommandArgument="CLOTH" OnClick="SelectCat" CssClass="CatBtn" />
...
<asp:Button ID="CatBook" runat="server" ClientIDMode="Static" Text="Book" CommandArgument="BOOK" OnClick="SelectCat" CssClass="CatBtn" />
<asp:Button ID="CatPotion" runat="server" ClientIDMode="Static" Text="Potion" CommandArgument="POTION" OnClick="SelectCat" CssClass="CatBtn"  />
...
<asp:DataList ID="itemLists"  RepeatDirection="Horizontal" RepeatColumns="4" runat="server" >
  ...
  <ItemTemplate>
     <asp:Label ID="itemName" runat="server" Text='<%# Eval("Name") %>' Width="100px" /><br />	  
	 ...
	 <asp:Label ID="itemNo" runat="server" Text='<%# Eval("RetailPrice") %>'  /> <br />
	...
	<table>
        <tr>
            <td><asp:LinkButton ID="BtnPrevious" runat="server" onclick="LinkButton2_Click" CssClass="DataPager">
				Previous</asp:LinkButton></td>
            <td><asp:LinkButton ID="BtnNext" runat="server" onclick="LinkButton3_Click" CssClass="DataPager">
				Next</asp:LinkButton></td>
        </tr>
    </table>  
	</div>
