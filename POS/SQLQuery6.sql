...
SELECT customerID AS NO,(fName + '  '+ lName ) AS NAME, email AS 'E-MAIL',city AS 'CITY',Province AS 'PROVINCE',convert(varchar, RegisterDate,106) AS 'REGISTER DATE' FROM tblCustomer WHERE lOWER(fName+lName) LIKE LOWER('%ss%');
